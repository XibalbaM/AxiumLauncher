package fr.xibalba.utils.annotations;
...
@SupportedAnnotationTypes("fr.xibalba.utils.annotations.BuilderProperty")
...
public class BuilderProcessor extends AbstractProcessor {
    ...
    public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
        ...
        processingEnv.getMessager().printMessage(Diagnostic.Kind.WARNING, "Hello");
