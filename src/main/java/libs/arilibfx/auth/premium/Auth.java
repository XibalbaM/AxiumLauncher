package libs.arilibfx.auth.premium;

import libs.arilibfx.auth.premium.exceptions.AuthenticationUnavailableException;
import libs.arilibfx.auth.premium.exceptions.InvalidCredentialsException;
import libs.arilibfx.auth.premium.exceptions.RequestException;
import libs.arilibfx.auth.premium.exceptions.UserMigratedException;
...
import libs.arilibfx.auth.premium.responses.LoginResponse;
import libs.arilibfx.auth.premium.responses.RequestResponse;
import libs.arilibfx.utils.JsonUtils;
...
/**
 * Created by Arinonia on 10/04/2020 inside the package - libs.arilibfx.auth.premium
 */
public class Auth {
